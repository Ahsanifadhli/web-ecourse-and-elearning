    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex gap-6">
        ...
        <div>
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('admin.courses.students', $course->id) }}" class="text-sm font-medium text-blue-600 hover:text-blue-800 flex items-center gap-1 w-fit mt-1">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <div class="flex gap-2">
                        ...
                        {{-- [MODIFIKASI] Tombol Hapus Bab dengan Modal --}}
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    @foreach($material->subMaterials as $sub)
                        <div class="px-6 py-3 flex items-center justify-between hover:bg-gray-50 transition">
                            ...
                            {{-- [MODIFIKASI] Tombol Hapus Materi --}}
                            <button onclick="confirmDelete('{{ route('admin.submaterials.destroy', $sub->id) }}')" 
                                    class="text-gray-400 hover:text-red-500 font-bold px-2 text-lg">
                                &times;
                            </button>
                        </div>
                    @endforeach
                    ...
                    @foreach($material->assignments as $assign)
                        <div class="px-6 py-3 flex items-center justify-between hover:bg-gray-50 bg-orange-50/30 border-l-4 border-l-transparent hover:border-l-orange-400 transition">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                {{-- [MODIFIKASI] Tombol Hapus Tugas --}}
                                <button onclick="confirmDelete('{{ route('admin.assignments.destroy', $assign->id) }}')" 
                                        class="text-gray-400 hover:text-red-500 font-bold text-lg">
                                    &times;
                                </button>
                            </div>
                        </div>
                    ...
                    @foreach($material->quizzes as $quiz)
                        <div class="px-6 py-3 flex items-center justify-between hover:bg-gray-50 bg-purple-50/30 border-l-4 border-l-transparent hover:border-l-purple-400 transition">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                {{-- [MODIFIKASI] Tombol Hapus Kuis --}}
                                <button onclick="confirmDelete('{{ route('admin.quizzes.destroy', $quiz->id) }}')" 
                                        class="text-gray-400 hover:text-red-500 font-bold text-lg">
                                    &times;
                                </button>
                            </div>
...
{{-- PANGGIL KOMPONEN MODAL DELETE DI SINI --}}
